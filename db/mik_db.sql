...
( 'Ajedrez | ADULTOS', 'Lo escuchaste, te gusto, queres intentar pero no sabes como leer una partitura? No hay drama! Aca en este curso te mostraremos como tocar el piano, leer las partituras y poder disfurtar tocar de este gran instrumento', 'prudcto-sin-foto.webp' , 9970, '', 1, 0,  0, 1),
( 'Piano | GENERAL', 'Aprende a tocar piano y leer partitura de manera facil y sencilla! Este curso te provee todo tipo de conocimientos', '' , 7870, 'prudcto-sin-foto.webp', 1, 0,  0, 1),
/* DESTACADOS */
...
('Idiomas | GENERAL', '¡Es momento de aprender idiomas, de abrir tu conocimiento en nuevas lenguas y poder ir a cualquier pais y poder hablar con tranquilidad! Tenemos todo tipo de niveles! Principiantes, Intermedio, Experimentado', 'prudcto-sin-foto.webp', 10700, '', 0, 1, 45, 1),
('Tenis | NIÑOS', 'Es momento que tu hijo/a aprenda un gran deporte como el tenis, donde se practica y se entrena con mucha responsabilidad.', '', 8522, 'prudcto-sin-foto.webp', 0, 1, 25, 1),

/* VARIADOS*/
( 'Locución | ADULTOS', 'Aqui te podes desenvolver de la mejor manera, en este curso, ¿Con qué? Con la Locucion, aprende a relatar, hablar y poder trasnmitir a travez de tu voz.', '' , 6678, 'prudcto-sin-foto.webp', 0, 0,  0, 1),
...
( 'MECANICA | GENERAL', '¿Eres de aquellos que quieren aprender a como arreglar un auto pero no saben como porque nunca supieron de mecanica? Este curso te eneseña TODO lo basico y mucho mas! Aprende y estaras mas tranquilo si algo pasa con tu auto porque sabras que hacer', '' , 1970, 'prudcto-sin-foto.webp', 0, 0,  0, 1),
( 'ATLETISMO | NIÑOS', 'Tu hijo le gusta correr, no sabes como pararlo, NO LO HAGAS! Muestrale estos videos de este curo el cual le enseñera tecnicas divertidas para empezar el atletismo de una manera dinamica y diferente.', '' , 9970, 'prudcto-sin-foto.webp', 0, 0,  0, 1),
