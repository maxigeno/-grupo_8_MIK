...
( 'Ajedrez | ADULTOS', 'Lo escuchaste, te gusto, queres intentar pero no sabes como leer una partitura? No hay drama! Aca en este curso te mostraremos como tocar el piano, leer las partituras y poder disfurtar tocar de este gran instrumento', '' , 9970, 'Ajedrez.jpg', 1, 0,  0, 1),
( 'Piano | GENERAL', 'Aprende a tocar piano y leer partitura de manera facil y sencilla! Este curso te provee todo tipo de conocimientos', '' , 7870, 'piano.jpg', 1, 0,  0, 2),
/* DESTACADOS */
