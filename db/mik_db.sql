...
( 'Ajedrez | ADULTOS', 'Lo escuchaste, te gusto, queres intentar pero no sabes como leer una partitura? No hay drama! Aca en este curso te mostraremos como tocar el piano, leer las partituras y poder disfurtar tocar de este gran instrumento', 'producto-sin-foto.webp' , 9970, '', 1, 0,  0, 1),
...
('Idiomas | GENERAL', '¡Es momento de aprender idiomas, de abrir tu conocimiento en nuevas lenguas y poder ir a cualquier pais y poder hablar con tranquilidad! Tenemos todo tipo de niveles! Principiantes, Intermedio, Experimentado', 'producto-sin-foto.webp', 10700, '', 0, 1, 45, 1),
