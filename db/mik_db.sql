...
( 'Yoga | GENERAL', 'En este curso de Yoga dominaras al conjunto de disciplinas y prácticas de tipo físico, mental y espiritual, cuyo objetivo es lograr el equilibrio entre el cuerpo y mente para alcanzar la iluminación y la trascendencia', '' , 9970, 'yoga.webp', 1, 0,  0, 3),
...
( 'Piano | GENERAL', 'Aprende a tocar piano y leer partitura de manera facil y sencilla! Este curso te provee todo tipo de conocimientos', '' , 7870, 'producto-sin-foto.webp', 1, 0,  0, 2),
/* DESTACADOS */
...
('Frances | ADULTO', '¡Es momento de aprender idiomas, de abrir tu conocimiento en nuevas lenguas y poder ir a cualquier pais y poder hablar con tranquilidad! Tenemos todo tipo de niveles! Principiantes, Intermedio, Experimentado', '', 10700, 'producto-sin-foto.webp', 0, 1, 45, 5),
...
( 'Manualidades | GENERAL', '¿Queres aprender a hacer pulseras, tobilleras, collares, aritos y muchas otras manualidades? Aqui te enseñaremos como hacerlo sin comprar materiales caros y con bajo presupuesto.', '' , 4570, 'prudcto-sin-foto.webp', 0, 0,  0, 4),
( 'MECANICA | GENERAL', '¿Eres de aquellos que quieren aprender a como arreglar un auto pero no saben como porque nunca supieron de mecanica? Este curso te eneseña TODO lo basico y mucho mas! Aprende y estaras mas tranquilo si algo pasa con tu auto porque sabras que hacer', '' , 1970, 'producto-sin-foto.webp', 0, 0,  0, 5),
